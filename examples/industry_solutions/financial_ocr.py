...
"""
Financial Document Labeling Example
--------------------------------
This example demonstrates how to use AI-Scout to automate data labeling
for training YOLO models on financial document imagery. AI-Scout combines
...
for training or fine-tuning YOLO models for document analysis applications.
"""
...
# Example: Label a financial document
image_path = os.path.join("..", "sample_images", "financial-document.jpg")

# Define target objects for document dataset
target_list = [
    "table",           # Financial tables, spreadsheets
    "cell phone",      # Mobile banking QR codes
    "logo",           # Company logos
    "signature box",   # Signature areas
    "stamp",          # Official stamps
    "barcode",        # Document barcodes
    "qr code"         # QR codes for digital payments
]
...
print("YOLO models for document analysis. Review the labeled images")
print("to ensure quality before using them in your training dataset.")
